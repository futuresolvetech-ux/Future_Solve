          ...
          <div className="relative w-full h-[400px] rounded-2xl overflow-hidden glass-card border border-white/5 hover:border-white/10 transition-all duration-300">
            ...
            <div className="absolute inset-0 z-20 flex items-center px-8 md:px-16">
              <div className="max-w-lg text-left">
                ...
                <Link 
                  to="/contact" 
                  className="inline-block bg-gradient-to-r from-indigo-500 to-cyan-500 hover:from-indigo-600 hover:to-cyan-600 text-white px-8 py-3.5 rounded-xl font-bold text-sm tracking-wide shadow-lg shadow-indigo-500/15 hover:shadow-cyan-500/25 hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 text-center animate-pulse-glow"
                >
                  Schedule a Consult
                </Link>
              </div>
